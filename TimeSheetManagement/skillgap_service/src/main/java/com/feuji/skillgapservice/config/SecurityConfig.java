...
public class SecurityConfig {
	...
	SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		return http.csrf().disable().authorizeHttpRequests()
				.requestMatchers("/skill/getBySkillId/{skillId}", "/skill/deleteSkill/{subSkillCategoryId}").permitAll()
				...
				.requestMatchers("/skill/updateStatus").hasAnyAuthority("Admin")

				.requestMatchers("/getRoles/{technicalCatId}", "/fetchBySkillId/{skillId}/{page}/{size}/{roleName}",
						"/skill/getSkillNames/{skillIds}", "/fetchallemployees/{skillIds}")
